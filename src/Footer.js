      ...
      <section>
        ...
        <div className="follow">
          <ul className="list-inline social">
            ...
            <li><a target="_blank" aria-label="Michael's LinkedIn" rel="noopener noreferrer" href="https://www.linkedin.com/in/mkohlerdev"><FontAwesomeIcon icon={faLinkedin} /></a></li>
