  ...
  return (
    <section id="opensource">
      ...
      <ul>
        ...
        <li>
          Mozilla Reps:&nbsp;
          <a href="https://community.mozilla.org/people/mkohler/">community.mozilla.org</a>
        </li>
        <li>
          People Directory:&nbsp;
      ...
      <section className="areas">
        ...
        <div className="area">
          <h4>Common Voice</h4>
          <p>2018 - now</p>
          <img src="/images/me.webp" alt="Michael listening at a conference" />
          <ul>
            <li>
            ...
            <li>
              Improving and maintaining the Common Voice Sentence Collector
            </li>
            <li>
              Improving and maintaining the Common Voice Sentence Extractor
            </li>
            <li>
              Answering questions about Common Voice in the forums
            </li>
          </ul>
        </div>
